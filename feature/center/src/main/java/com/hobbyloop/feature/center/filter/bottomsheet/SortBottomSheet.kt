        ...
        SortingOption.entries.forEach { sortingOption ->
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .clickable {
                        if (filterState.sort == sortingOption) {
                            filterStateUpdate(filterState.copy(sort = null))
                        } else {
                            filterStateUpdate(filterState.copy(sort = sortingOption))
                        }
                    }
                ...
                Text(
                    ...
                    color = if (filterState.sort == sortingOption) HobbyLoopColor.Primary else Color.Black,
