...
import com.hobbyloop.core.ui.util.LazyListUtil.calculateAdjustmentAfterCompletion
import com.hobbyloop.core.ui.util.LazyListUtil.calculateViewportCenter
import com.hobbyloop.core.ui.util.LazyListUtil.filterFullyVisibleItems
import com.hobbyloop.core.ui.util.LazyListUtil.findClosestCenterItem
import com.hobbyloop.core.ui.componenet.monthly_calendar.component.MonthlyCalendarItem
...
fun CurrentMonthlyReservationCalendar(
    ...
    baseColor: Color = HobbyLoopColor.Primary,
    colorMode: ColorMode = ColorMode.POSITION_BASED,
    positionBasedModeLeftBackgroundColor: Color = HobbyLoopColor.Gray20,
    positionBasedModeRightBackgroundColor: Color = HobbyLoopColor.Gray40,
    positionBasedModeLeftTextColor: Color = HobbyLoopColor.Gray40,
...
fun PreviewCurrentMonthlyReservationCalendarView() {
    Surface {
        CurrentMonthlyReservationCalendarView(
            ...
            isLoading = false,
            errorMessage = null,
            baseColor = HobbyLoopColor.Primary,
            colorMode = ColorMode.POSITION_BASED,
            positionBasedModeLeftBackgroundColor = HobbyLoopColor.Gray20,
            positionBasedModeRightBackgroundColor = HobbyLoopColor.Gray40,
            positionBasedModeLeftTextColor = HobbyLoopColor.Gray40,
